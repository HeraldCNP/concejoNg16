...
@Component({
  ...
  styleUrls: ['./list-correspondencia.component.scss']
})
export class ListCorrespondenciaComponent implements OnInit {
  ...
  obtener(form: any) {
    let tipo: string = 'correspondencias';
    let subTipo: string = '';
  ...
  deleteArchivoResolucion(id: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.router.navigate(['carpetas/listCorrespondencia', this.carpetaId]);
      }
    });
  ...
  createArchivoCorrespondencia(id: any) {
    this.router.navigate(['carpetas/createCorrespondencia', id]);
  }

  editArchivoCorrespondencia(id: any) {
    this.router.navigate(['carpetas/updateCorrespondencia', id]);
  }
}
