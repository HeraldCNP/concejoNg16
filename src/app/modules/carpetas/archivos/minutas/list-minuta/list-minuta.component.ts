...
export class ListMinutaComponent implements OnInit {
  ...
  deleteArchivoResolucion(id: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.router.navigate(['carpetas/listMinuta', this.carpetaId]);
      }
    });
  ...
  createArchivoMinuta(id: any) {
    this.router.navigate(['carpetas/createMinuta', id]);
  }

  editArchivoMinuta(id: any) {
    this.router.navigate(['carpetas/updateMinuta', id]);
  }
