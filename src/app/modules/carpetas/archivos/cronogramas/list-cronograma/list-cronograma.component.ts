...
export class ListCronogramaComponent implements OnInit {
  ...
  displayedColumn: string[] = ['numero', 'detalle', 'fechaAprobacion', 'fojas', 'origen', 'archivo', 'observaciones', 'acciones'];
  ...
  deleteArchivoResolucion(id: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.router.navigate(['carpetas/listCronograma', this.carpetaId]);
      }
    });
  ...
  createArchivoCronograma(id: any) {
    this.router.navigate(['carpetas/createCronograma', id]);
  }

  editArchivoCronograma(id: any) {
    this.router.navigate(['carpetas/updateCronograma', id]);
  }
