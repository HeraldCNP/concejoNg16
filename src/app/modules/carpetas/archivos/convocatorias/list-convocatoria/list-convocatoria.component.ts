...
@Component({
  ...
  styleUrls: ['./list-convocatoria.component.scss']
})
export class ListConvocatoriaComponent implements OnInit {
  ...
  displayedColumn: string[] = ['numero', 'detalle', 'fechaAprobacion', 'fojas', 'archivo', 'observaciones', 'acciones'];
  ...
  deleteArchivoResolucion(id: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.router.navigate(['carpetas/listConvocatoria', this.carpetaId]);
      }
    });
  ...
  createArchivoLey(id: any) {
    this.router.navigate(['carpetas/createConvocatoria', id]);
  }

  editArchivoLey(id: any) {
    this.router.navigate(['carpetas/updateConvocatoria', id]);
  }
