...
@Component({
  selector: 'app-list-inf-comision',
  templateUrl: './list-inf-comision.component.html',
  styleUrls: ['./list-inf-comision.component.scss']
})
export class ListInfComisionComponent implements OnInit {
  ...
  deleteArchivoResolucion(id: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.router.navigate(['carpetas/listInfComision', this.carpetaId]);
      }
    });
  ...
  createArchivoInfComision(id: any) {
    this.router.navigate(['carpetas/createInfComision', id]);
  }

  editArchivoInfComision(id:any){
    this.router.navigate(['carpetas/updateInfComision', id]);
  }
