...
@Component({
  selector: 'app-list-in-fiscalizacion',
  templateUrl: './list-in-fiscalizacion.component.html',
  styleUrls: ['./list-in-fiscalizacion.component.scss']
})
export class ListInFiscalizacionComponent implements OnInit {
  ...
  displayedColumn: string[] = ['numero', 'detalle', 'fechaAprobacion', 'fechaPromulgacion', 'fojas', 'origen', 'archivo', 'observaciones', 'acciones'];
  ...
  obtener(form: any) {
    let tipo: string = 'infiscalizacion';
    let subTipo: string = '';
  ...
  deleteArchivoResolucion(id: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.router.navigate(['carpetas/listInFiscalizacion', this.carpetaId]);
      }
    });
  ...
  createArchivoInFiscalizacion(id: any) {
    this.router.navigate(['carpetas/createInFiscalizacion', id]);
  }

  editArchivoInFiscalizacion(id: any) {
    this.router.navigate(['carpetas/updateInFiscalizacion', id]);
  }
