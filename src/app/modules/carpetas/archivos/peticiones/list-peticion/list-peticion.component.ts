...
@Component({
  selector: 'app-list-peticion',
  templateUrl: './list-peticion.component.html',
  styleUrls: ['./list-peticion.component.scss']
})
export class ListPeticionComponent implements OnInit {
  ...
  displayedColumn: string[] = ['numero', 'detalle', 'fechaAprobacion', 'fechaPromulgacion', 'fojas', 'destino', 'archivo', 'observaciones', 'acciones'];
  ...
  deleteArchivoResolucion(id: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.router.navigate(['carpetas/listPeticion', this.carpetaId]);
      }
    });
  ...
  createArchivoPeticion(id: any) {
    this.router.navigate(['carpetas/createPeticion', id]);
  }

  editArchivoPeticion(id: any) {
    this.router.navigate(['carpetas/updatePeticion', id]);
  }
}
