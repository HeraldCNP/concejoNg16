...
@Component({
  selector: 'app-create-ley',
  templateUrl: './create-ley.component.html',
  styleUrls: ['./create-ley.component.scss']
})
export class CreateLeyComponent implements OnInit {
    ...
    if (this.archivoForm.valid) {
      ...
      this.archivoService.createArchivo(formData).subscribe((event:any) => {
        if (event.type === HttpEventType.UploadProgress) {
          ...
          this.router.navigate(['carpetas/listLey', this.idCarpeta]);
        }
      });
    }
    else{
